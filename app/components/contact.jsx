	...
	return (
		<section id='contacts'>
			<div className='bg-[#2D2F30] w-full h-[500px] flex justify-center'>
				<div
					className=' bg-[#58AEE6]  md:w-3/4 h-[500px] rotate-2 	 	flex flex-col absolute items-center
				'
				>
					...
					<div className='md:pb-20 pb-10 md:px-0 px-10'>
						<div className='-rotate-2 text-white  md:text-xs text-[8px] flex md:flex-row flex-col    gap-2 items-center border-t pt-5 w-[px] pl-10'>
